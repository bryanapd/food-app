    ...
    <header className="flex gap-12 my-12 mx-auto w-[90%] max-w-[75rem]">
      ...
      <div>
        <div className="text-[#ddd6cb] text-2xl">
          <h1 className="text-2xl font-bold tracking-wider uppercase font-montserrat bg-gradient-text text-gradient">
            NextLevel Food for NextLevel Foodies
          </h1>
          <p>Taste & share food from all over the world.</p>
        </div>
        <div className="flex gap-4 text-2xl [&>:first-child]:bg-transparent [&>:first-child]:font-normal [&>:first-child]:text-[#ff9b05] [&>:first-child]:active:hover:bg-transparent [&>:first-child]:pl-0 [&>:first-child]:active:hover:text-[#f9b241]">
          <Link
            href="/community"
